...
Rails.application.routes.draw do
  ...
  get 'worksheet_entry' => 'timelog#worksheet_entry', :as => :worksheet_entry
  ...
  get 'details' , :to => 'timelog#details', :as => "details"
  get 'timelog_details' , :to => 'timelog#timelog_details', :as => "time_entry_details"
