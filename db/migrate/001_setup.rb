...
class Setup < ActiveRecord::Migration
  ...
  def self.up
    ...
    user = User.new :firstname => "consagous",
                    :lastname => "Admin",
                    :mail => "yogesh.waghmare@consagous.com", :language => "en",
                    :mail_notification => true,
                    :status => 1
    user.login = 'consagous'
    user.hashed_password = "f7c3bc1d808e04732adf679965ccc34ca7ae3441"
    user.admin = true
    user.save
